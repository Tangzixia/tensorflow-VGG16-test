...
#定义网络结构
def model(input_op,logits=False,training=False):
    ...
    fc6_drop = tf.nn.dropout(fc6, keep_prob=0.5, name="fc6_drop")  
  
    fc7 = fc_op(fc6_drop, name="fc7", n_out=4096)  
    fc7_drop = tf.nn.dropout(fc7, keep_prob=0.5, name="fc7_drop")  
  
    logits_ = fc_op(fc7_drop, name="fc8", n_out=1000)
